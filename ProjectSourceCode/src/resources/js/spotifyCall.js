...
module.exports.createRecommendedPlaylist = async function createRecommendedPlaylist(savedToken, recommendedTracks, genreInput){
    ...
    const createdPlaylist = await fetch(`https://api.spotify.com/v1/users/smedjan/playlists`, {
        method: "POST",
        headers: { 
            'Authorization': 'Bearer ' + savedToken 
        },
    ...
    const populatedPlaylist = await fetch(`https://api.spotify.com/v1/playlists/${playlist_id}/tracks`, {
        method: "POST",
        headers: { 
            'Authorization': 'Bearer ' + savedToken 
        },
